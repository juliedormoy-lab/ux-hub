  ...
  return (
    ...
    >
      ...
      <section className="mb-10">
        ...
        <Card className="mb-8 p-5 bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-white rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="font-display font-bold text-surface-900">
                {locale === 'fr' ? 'Aide à la décision : Quelle approche UX choisir ?' : 'Decision help: Which UX approach to choose?'}
              </h3>
              <p className="text-xs text-surface-500">
                {locale === 'fr' ? 'Adaptez votre méthodologie à votre contexte projet' : 'Adapt your methodology to your project context'}
              </p>
            </div>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-indigo-100">
                  <th className="text-left py-3 px-4 font-semibold text-indigo-900 rounded-tl-lg">
                    {locale === 'fr' ? 'Votre situation' : 'Your situation'}
                  </th>
                  <th className="text-left py-3 px-4 font-semibold text-indigo-900">
                    {locale === 'fr' ? 'Méthode recommandée' : 'Recommended method'}
                  </th>
                  <th className="text-left py-3 px-4 font-semibold text-indigo-900 rounded-tr-lg">
              ...
              <tbody className="divide-y divide-indigo-100 bg-white/80">
                <tr>
                  <td className="py-3 px-4 text-surface-700">
                    {locale === 'fr' ? 'Projet simple, utilisateurs homogènes' : 'Simple project, homogeneous users'}
                  </td>
                  <td className="py-3 px-4">
                    <Badge className="bg-blue-100 text-blue-700">Task-based</Badge>
                  </td>
                  <td className="py-3 px-4 text-surface-600 text-xs">
                    {locale === 'fr' ? 'Liste de tâches + parcours détaillés' : 'Task list + detailed journeys'}
                  </td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-surface-700">
                    {locale === 'fr' ? 'Transformation digitale, change management' : 'Digital transformation, change management'}
                  </td>
                  <td className="py-3 px-4">
                    <Badge className="bg-purple-100 text-purple-700">User Journey</Badge>
                  </td>
                  <td className="py-3 px-4 text-surface-600 text-xs">
                    {locale === 'fr' ? 'Journey maps + moments de vérité' : 'Journey maps + moments of truth'}
                  </td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-surface-700">
                    {locale === 'fr' ? 'Plateforme multi-publics (B2C + B2B)' : 'Multi-audience platform (B2C + B2B)'}
                  </td>
                  <td className="py-3 px-4">
                    <Badge className="bg-green-100 text-green-700">Persona</Badge>
                  </td>
                  <td className="py-3 px-4 text-surface-600 text-xs">
                    {locale === 'fr' ? 'Personas + parcours distincts' : 'Personas + distinct journeys'}
                  </td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-surface-700">
                    {locale === 'fr' ? 'Refonte technique, architecture modulaire' : 'Technical redesign, modular architecture'}
                  </td>
                  <td className="py-3 px-4">
                    <Badge className="bg-orange-100 text-orange-700">Module</Badge>
                  </td>
                  <td className="py-3 px-4 text-surface-600 text-xs">
                    {locale === 'fr' ? 'Architecture fonctionnelle + flux' : 'Functional architecture + flows'}
                  </td>
                </tr>
                <tr>
                  <td className="py-3 px-4 text-surface-700">
                    {locale === 'fr' ? 'Projet complexe ou d\'envergure' : 'Complex or large-scale project'}
                  </td>
                  <td className="py-3 px-4">
                    <Badge className="bg-red-100 text-red-700">{locale === 'fr' ? 'Hybride 3 niveaux' : 'Hybrid 3 levels'}</Badge>
                  </td>
                  <td className="py-3 px-4 text-surface-600 text-xs">
                    {locale === 'fr' ? 'Personas + modules + flux critiques' : 'Personas + modules + critical flows'}
                  </td>
                </tr>
              </tbody>
            </table>
